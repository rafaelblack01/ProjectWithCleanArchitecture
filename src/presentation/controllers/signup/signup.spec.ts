...
describe('SignUp Controller', () => {
  test('Should return 400 if no name is provined', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
  ...
  test('Should return 400 if no email is provined', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should return 400 if no password is provined', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should return 400 if no password confirmation is provined', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
